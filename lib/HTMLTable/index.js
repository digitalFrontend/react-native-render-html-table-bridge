...
const tableStylePropTypeSpec = {
    ...
    borderWidthPx: prop_types_1.default.number.isRequired,
    cellPaddingEm: prop_types_1.default.number.isRequired,
    fitContainer: prop_types_1.default.bool.isRequired,
    selectableText: prop_types_1.default.bool.isRequired,
    thEvenBackground: prop_types_1.default.string.isRequired,
    thEvenColor: prop_types_1.default.string.isRequired,
    thOddBackground: prop_types_1.default.string.isRequired,
    thOddColor: prop_types_1.default.string.isRequired
};
class HTMLTable extends react_1.PureComponent {
    ...
    buildHTML() {
        ...
        const styleSpecs = tableStyleSpecs ? tableStyleSpecs : Object.assign(Object.assign({}, css_rules_1.defaultTableStylesSpecs), { fitContainer: !autoheight });
    ...
    render() {
        const { autoheight, style, WebViewComponent, webViewProps, useLayoutAnimations, sourceBaseUrl } = this.props;
        ...
        return (react_1.default.createElement(react_native_1.Animated.View, { style: [containerStyle, styles.container, style], renderToHardwareTextureAndroid: true },
            react_1.default.createElement(WebView, Object.assign({ androidHardwareAccelerationDisabled: true, scalesPageToFit: react_native_1.Platform.select({ android: false, ios: undefined }), automaticallyAdjustContentInsets: false, scrollEnabled: true, style: [react_native_1.StyleSheet.absoluteFill, webViewProps && webViewProps.style], contentInset: defaultInsets }, webViewProps, { injectedJavaScript: script_1.default, javaScriptEnabled: true, onMessage: this.handleOnMessage, source: source, androidHardwareAccelerationDisabled: true, }))));
    }
}
...
HTMLTable.propTypes = {
    ...
    tableStyleSpecs: prop_types_1.default.shape(tableStylePropTypeSpec),
    ...
    sourceBaseUrl: prop_types_1.default.string,
    renderersProps: prop_types_1.default.any
};
